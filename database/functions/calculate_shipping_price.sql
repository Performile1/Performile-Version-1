...
-- Purpose: Calculate shipping price based on courier pricing rules
-- Date: November 19, 2025
-- Status: CRITICAL - Core pricing calculation function
-- ============================================================================
...
-- Test 1: Basic calculation (Oslo to Oslo, 5kg, 50km)
-- SELECT calculate_shipping_price(
--   (SELECT courier_id FROM couriers WHERE courier_name = 'PostNord' LIMIT 1),
--   'standard',
--   5.0,
--   50,
--   '0150',
...
-- Test 3: Express service, heavier package
-- SELECT calculate_shipping_price(
--   (SELECT courier_id FROM couriers WHERE courier_name = 'PostNord' LIMIT 1),
--   'express',
--   15.0,
...
-- COMPLETION STATUS
-- ============================================================================
-- ✅ Function created with full pricing logic
-- ✅ Handles base price, weight tiers, distance tiers
-- ✅ Applies zone multipliers
-- ✅ Calculates fixed and percentage surcharges
-- ✅ Enforces min/max price constraints
-- ✅ Returns detailed breakdown in JSON
