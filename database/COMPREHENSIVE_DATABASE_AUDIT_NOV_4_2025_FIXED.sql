-- COMPREHENSIVE DATABASE AUDIT - November 4, 2025 (FIXED)
-- Purpose: Complete audit of all tables, functions, views, and identify issues
-- Run this in Supabase SQL Editor
-- FIXED: Subquery issues resolved
...
-- ============================================
-- 2. LIST ALL TABLES WITH DETAILS (FIXED)
-- ============================================
SELECT 
    t.table_name,
...
-- ============================================
-- 13. CHECK FOR DUPLICATE DATA STORAGE (FIXED)
-- ============================================
...
-- ============================================
-- 18. TABLE RELATIONSHIPS (SIMPLIFIED)
-- ============================================
-- Note: Simplified to avoid aggregate function conflicts
SELECT 
    tc.table_name,
