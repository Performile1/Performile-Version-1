...
- Failed Calls: 0
- Slow Calls (>1s): 4
- Average Response Time: 816.75ms

## Calls by Endpoint
- /api/auth: 1 calls
- /api/notifications: 2 calls
- /api/trustscore/dashboard: 2 calls
...
- Status: 200
- Duration: 794ms
- Timestamp: 2025-10-21T07:44:48.317Z
- Request Body: ```json
{
  "action": "login",
...
- Response Body: ```json
{
  ...
  "data": {
    "user": {
      ...
      "updated_at": "2025-10-21T07:44:45.133Z"
    },
    "tokens": {
      "accessToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..UKEBO2usSsy36hMtCDG-1oofk4Eef7gH3bAEQiQTXfA",
      "refreshToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNzM4YjJhMjMtZjdhOS00YzE0LWE0ZDAtY2RjMDVhNTU5MmZhIiwidXNlcklkIjoiNzM4YjJhMjMtZjdhOS00YzE0LWE0ZDAtY2RjMDVhNTU5MmZhIiwiaWF0IjoxNzYxMDMyNjg5LCJleHAiOjE3NjE2Mzc0ODl9.3INjBzO66fPbOKEhFRUzx8TBY8vZyntR94CkQBqxuOA"
    }
  }
}
```
...
- Status: 200
- Duration: 306ms
- Timestamp: 2025-10-21T07:44:49.224Z
- Response Body: ```json
{
  "success": true,
  "data": [],
...
- Status: 200
- Duration: 189ms
- Timestamp: 2025-10-21T07:44:49.560Z
- Response Body: ```json
{
  "success": true,
  "data": [],
...
### 4. GET /api/trustscore/dashboard
- Status: 200
- Duration: 1003ms
- Timestamp: 2025-10-21T07:44:49.227Z
- Response Body: ```json
{
  "success": true,
  "data": {
...
### 5. GET /api/trustscore/dashboard
- Status: 200
- Duration: 1034ms
- Timestamp: 2025-10-21T07:44:49.563Z
- Response Body: ```json
{
  "success": true,
  "data": {
...
- Status: 200
- Duration: 991ms
- Timestamp: 2025-10-21T07:44:50.661Z
- Response Body: ```json
{
  "success": true,
  "data": [
...
- Status: 200
- Duration: 1005ms
- Timestamp: 2025-10-21T07:44:50.662Z
- Response Body: ```json
{
  "success": true,
  "data": [
...
- Status: 200
- Duration: 1212ms
- Timestamp: 2025-10-21T07:44:50.664Z
- Response Body: ```json
{
  "success": true,
  "data": {
